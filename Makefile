...
## build-test: build to linux executable, for LAN deploy manually.
build-test:
	@echo "  >  Building test (plan9 windows linux darwin) binary..."
	@echo "  >  LDFLAGS = $(LDFLAGS)"
	$(foreach an, cmdr-http2, \
	$(foreach os, plan9 windows linux darwin, \
